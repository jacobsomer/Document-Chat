...
function addDataSources(messages: ChatCompletionRequestMessage[], dataSources: string[]) {
...
async function createStream(messages: ChatCompletionRequestMessage[], model: OaiModel) {
